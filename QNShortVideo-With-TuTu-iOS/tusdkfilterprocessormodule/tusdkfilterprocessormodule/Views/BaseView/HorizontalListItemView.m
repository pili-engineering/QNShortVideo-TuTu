...
- (void)commonInit {
    ...
    _selectedImageView.image = [UIImage imageNamedWithNormalBundle:@"ic_parameter"];
...
+ (instancetype)disableItemView {
    HorizontalListItemView *itemView = [HorizontalListItemView itemViewWithImage:[UIImage imageNamedWithNormalBundle:@"ic_nix"] title:nil];
