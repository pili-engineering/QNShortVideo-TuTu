...
- (void)setupData {
    NSArray *filterCodes = [TuSDKManager sharedManager].cartoonCodes;
    ...
    [self addItemViewsWithCount:filterCodes.count config:^(HorizontalListView *listView, NSUInteger index, HorizontalListItemView *itemView) {
        ...
        NSString *imagePath = [[TuSDKManager sharedManager].resourceBundle pathForResource:imageName ofType:@"jpg"];
