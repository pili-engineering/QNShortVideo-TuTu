...
- (void)loadData {
    ...
    if ([PropsItemMonsterCategory allCategories] && [TuSDKManager sharedManager].isShowDistortingMirror)
...
- (void)propsItemsPageView:(PropsItemsPageView *)pageView didTapDeleteButtonAtIndex:(NSInteger)index {
    NSString *title = NSLocalizedStringFromTable(@"tu_确认删除本地文件？", @"TuSDKConstants", @"确认删除本地文件？");
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:title message:nil preferredStyle:UIAlertControllerStyleAlert];
    [alertController addAction:[UIAlertAction actionWithTitle:NSLocalizedStringFromTable(@"tu_取消", @"TuSDKConstants", @"取消") style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
        [self.currentCategoryPageView dismissDeleteButtons];
    }]];
    
    typeof(self) weakSelf = self;
    [alertController addAction:[UIAlertAction actionWithTitle:NSLocalizedStringFromTable(@"tu_删除", @"TuSDKConstants", @"删除") style:UIAlertActionStyleDestructive handler:^(UIAlertAction * _Nonnull action) {
