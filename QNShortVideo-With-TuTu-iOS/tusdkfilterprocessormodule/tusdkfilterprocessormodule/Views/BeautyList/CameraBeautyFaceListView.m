...
- (void)commonInit {
    [super commonInit];
    NSArray *faceFeatures = [TuSDKManager sharedManager].beautyFaceKeys;
    ...
    HorizontalListItemView *resetItemView = [CameraBeautyFaceListItemView itemViewWithImage:[UIImage imageNamedWithNormalBundle:@"face_ic_reset"] title:NSLocalizedStringFromTable(@"tu_重置", @"TuSDKConstants", @"重置")];
