...
- (void)commonInit {
    ...
    _downloadIconView = [[UIImageView alloc] initWithImage:[UIImage imageNamedWithNormalBundle:@"video_ic_download"]];
    ...
    [_deleteButton setImage:[UIImage imageNamedWithNormalBundle:@"video_ic_delete"] forState:UIControlStateNormal];
